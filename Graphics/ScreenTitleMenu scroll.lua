...
t[#t+1] = LoadFont("Common Bold")..{
	...
	GainFocusCommand=function(self) self:stoptweening():zoom(0.5):accelerate(0.1):diffuse(color("#e88300")):glow(1,1,1,0.5):decelerate(0.05):glow(1,1,1,0) end,
	LoseFocusCommand=function(self) self:stoptweening():zoom(0.4):accelerate(0.1):diffuse(color("#fbff94")):glow(1,1,1,0) end
}
