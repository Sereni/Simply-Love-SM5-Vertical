if SL.Global.GameMode ~= "Casual" then
	...
	return Def.ActorFrame{
		...
		Def.Quad{
			InitCommand=function(self) self:diffuse(color("#1E282F")):zoomto(210, 18) end
		},

		LoadFont("Common Normal")..{
			Text=optionslist,
			InitCommand=function(self) self:zoom(font_zoom):xy(-95,-4):align(0,0):vertspacing(-6):_wrapwidthpixels(200 / font_zoom) end
		}
	}
end
